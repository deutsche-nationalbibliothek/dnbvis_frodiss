...
with st.sidebar:
        ...
        with st.container():
                ...
                st.markdown('<style>img {width: 75px; align: center;}</style><img src="https://raw.githubusercontent.com/deutsche-nationalbibliothek/dnbvis_frodiss/main/GitHub_Logo.png">', unsafe_allow_html=True)
