...
with st.sidebar:
        ...
        with st.container():
                ...
                #st.markdown('''<img src="https://raw.githubusercontent.com/deutsche-nationalbibliothek/dnbvis_frodiss/main/GitHub_Logo.png", width=75>''', unsafe_allow_html=True)
                st.markdown('<style>img {width: 75px; display: block; margin-left: auto; margin-right: auto;}</style><img src="https://raw.githubusercontent.com/deutsche-nationalbibliothek/dnbvis_frodiss/main/GitHub_Logo.png">', unsafe_allow_html=True)
