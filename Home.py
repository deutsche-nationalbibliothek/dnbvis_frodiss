...
with st.sidebar:
        ...
        with st.container():
                st.markdown("[![DNBVIS_frodiss auf GitHub](https://github.com/deutsche-nationalbibliothek/dnbvis_frodiss/blob/main/GitHub_Logo.png)](https://github.com/deutsche-nationalbibliothek/dnbvis_frodiss)")
